...
public class ConvertingService {
    ...
    public String createPdf(List<Pdf> pdfs) throws IOException, DocumentException {
    ...
    private static void addData(Document document, List<Pdf> pdfs) throws DocumentException, IOException {
        for (Pdf pdf : pdfs) {
            BaseFont times = BaseFont.createFont("pdfUtils/8277.ttf", "cp1251", BaseFont.EMBEDDED);
            ...
            Image img = Image.getInstance("pdfUtils/kfu.jpg");
